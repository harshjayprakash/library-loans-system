...
public class SidePane extends VBox {
    ...
    private void initialiseControls() {
        ...
        this.homePageButton.setId("side-pane__toggle-button");
        ...
        this.inventoryPageButton.setId("side-pane__toggle-button");
        ...
        this.customersPageButton.setId("side-pane__toggle-button");
        ...
        this.loansPageButton.setId("side-pane__toggle-button");
